...
class CodegenLoader extends AssetLoader{
  ...
  "subAppGoal": "Uygulamanın amacı neymiş bakalım.",
...
static const Map<String,dynamic> ru_RU = {
  ...
  "goalText": "Во первых, приложение подходит людям всех возрастов. Если вам нравятся утки, вы можете использовать это приложение, если хотите узнать больше интересных фактов об утках. Информации также существуют в интернете, но в этом приложении вся она собрана.",
  ...
  "subInspText": "В некоторых вкладках приложения такое вдохновление отображается.",
